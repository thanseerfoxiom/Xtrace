...
import { fetchHaccapItems, fetchRestuarent } from '../../../api/index.js';
...
import { Haccapapi, restaurantsapi } from '../../../services/BaseUrls.jsx';
...
export default function HaccapList() {
  ...
  console.log("statsusas",haccallist?.data?.docs)
  ...
  const handleSubmit = (values, actions) => {
    const apiurl = values?.id? `${Haccapapi}/${values.id}` : Haccapapi;
    mutation.mutate({
                  ...
                  <div className="card border-0 px-25">
                    ...
                    <div className="card-body p-0">
                      <div className="tab-content">
                        ...
                        >
                          <Table data={haccallist?.data?.docs??[]} columns={columns} setParams={setParams}
                           pagination={{
                            page: params.page,
                            limit: params.limit,
                            totalPages: haccallist?.data?.metadata.totalPages,
                            hasNext: haccallist?.data?.metadata.hasNext,
                            hasPrevious: haccallist?.data?.metadata.hasPrevious,
                          }} />
  ...
  <Formik
    ...
    validate={values => {
      const errors = {};
      if (!values.name) errors.name = 'Haccap Name Required';
      // if (!values.phone) {
